    ...
    public static JSONObject getProxy() {
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                JSONObject response = TemplateUtil.getResponse(restTemplate, "http://webapi.http.zhimacangku.com/getip?neek=d1fa042275328b9a&num=1&type=2&time=2&pro=0&city=0&yys=0&port=11&pack=0&ts=1&ys=0&cs=1&lb=1&sb=&pb=4&mr=3&regions=130000username=chukou01&spec=1", HttpMethod.GET, new HttpEntity<>(proxyHeaders));
